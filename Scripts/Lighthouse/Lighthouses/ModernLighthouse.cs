...
{
    public class ModernLighthouse : LighthouseBase
    {
        [SerializeField] private SectorLightzone lightzone;

        public override LightzoneBase Lightzone => lightzone;
        public override LighthouseStatLevels StatLevels { get; set; }
        public override LighthouseId Id => LighthouseId.Modern;
        
        //todo refactor lighthouse base and standard
