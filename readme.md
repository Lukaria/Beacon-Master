...
## Q&A
- **How can I play?**
The game is currently in the testing phase (Google Play requires 12 testers for public release). Soon You can join as a tester or download right now the latest release [directly from GitHub](https://github.com/Lukaria/Beacon-Master/releases/latest) (available for Android. iOS will be avaiable soon too).
